package com.wlsj.wlsjbi.config;
...
public class Knife4jConfig {
    ...
    public Docket defaultApi2() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                // 指定 Controller 扫描包路径
                .apis(RequestHandlerSelectors.basePackage("com.wlsj.wlsjbi.controller"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                .contact(new Contact("wlsj", "https://blog.csdn.net/qq_56098191", "2927527234@qq.com"))
                // 版本
                .version("1.0")
                // 构建
                .build();
